...
/**
 * @ClassName: StockInAndOutDomesticController.java
 * @Description:
 * @author: LiYu
 * @date: 2017年7月17日下午3:02:51
 * @version: 1.0 版本初成
 */
public class StockInAndOutDomesticController extends Controller {
    /** 
    * @Title: index 
    * @Description: 出入库明细页面
    * @author liyu
    */
    public void index() {
        render("stock_in_and_out_domestic.html");
    }
    ...
    */
    public void getJson(){
        ...
        Page<Record> page = StockInAndOutDomesticService.getDataPages(pageindex, pagelimit, in_date, company_name, material_no);
    ...
    */
    public void getRecord() {
        ...
        // 
        Record record = StockInAndOutDomesticService.getRecord(batch_no);
        setAttr("record", record);
        
        render("stock_in_and_out_domestic_detail.html");
    }
    ...
    */
    public void save() {
        ...
        // 
        boolean result = StockInAndOutDomesticService.save(batch_no, in_date, out_date);
