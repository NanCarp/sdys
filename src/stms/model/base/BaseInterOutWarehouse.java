...
public abstract class BaseInterOutWarehouse<M extends BaseInterOutWarehouse<M>> extends Model<M> implements IBean {
	...
	public M setNoticeNo(java.lang.String noticeNo) {
		set("notice_no", noticeNo);
		return (M)this;
	}

	public java.lang.String getNoticeNo() {
		return get("notice_no");
	}

	public M setCustomerInvoiceNo(java.lang.String customerInvoiceNo) {
		set("customer_invoice_no", customerInvoiceNo);
		return (M)this;
	}

	public java.lang.String getCustomerInvoiceNo() {
		return get("customer_invoice_no");
	}
